DECLARE @TableName NVARCHAR(128) = '[dbo].[VerificationStatuses]';

PRINT 'Seeding Table ' + @TableName;
...
PRINT @TableName + 'has been seeded. Rows affected: ' + CAST(@RowCount AS VARCHAR(10));