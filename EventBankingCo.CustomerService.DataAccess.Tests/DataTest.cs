...
namespace EventBankingCo.CustomerService.DataAccess.Tests
{
    public abstract class DataTest
    {
        ...
        /// </summary>
        protected const string TestDatabaseConnectionString = "Server=localhost,1433;Database=CustomerService;User Id=sa;Password=EventBankingCo_CustomerService_DB_Password;Encrypt=False;";
