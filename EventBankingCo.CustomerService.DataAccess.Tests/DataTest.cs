...
namespace EventBankingCo.CustomerService.DataAccess.Tests
{
    public abstract class DataTest
    {
        ...
        /// </summary>
        protected const string TestDatabaseConnectionString = "Server=localhost,1433;Database=EventBankingCo_CustomerService_Test;User Id=sa;Password=3v3nTp@sSw0rD;Encrypt=False;";
